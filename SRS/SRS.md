...
In the main activity, the user is able to create a new event (one-time or annual) under specification of the date, a description and the type of the event (birthday, anniversary, …). [UCS](https://github.com/Honrix/PlandoraDocumentation/blob/main/UCS/01_Create Event/Create%20Event.md)
...
### 3.4 Performance
See [SAD](https://github.com/Honrix/PlandoraDocumentation/blob/ad51559f201ff16084acbfcfcd0fea8e17974b63/SAD/SAD.md#10-size-and-performance)
